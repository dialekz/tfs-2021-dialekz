...
trait FlatMap[F[_]] { // <-- Future[_], Try[_], Option[_], Either[Throwable, _], ...
...
object Main extends App {
  ...
  // функция, принимающее некоторое T и применяющее к нему список трансформаций. Нам не важно, какой тип у T до тех пор
  // пока для этого T есть экземпляр тайпкласса FlatMap
